...
**Free for you, forever:** We provide 90 days of data history for free, forever. We provide [premium plans](https://app.antenna.dev/code_time/billing) for advanced features and historical data access.
...
![Code Time features for VS Code](https://assets.antenna.dev/readme/code-time/vscode/features-2.7.3.png)
...
![Code Time programming metrics](https://assets.antenna.dev/readme/code-time/vscode/improve-your-focus-2.7.3.png)
...
![Code Time web app](https://assets.antenna.dev/readme/code-time/vscode/optimize-code-time-2.7.3.png)
...
![Antenna.dev engineering metrics](https://assets.antenna.dev/readme/code-time/vscode/collaborate-more-efficiently-2.7.3.png)

Take your team to the next level. antenna.dev makes it easy to automatically track engineering KPIs, including lead time, deployment frequency, and more.
...
[More details here](https://docs.antenna.dev/article/43-code-time-data)
