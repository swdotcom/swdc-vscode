...
export const connectCodeTimeTeamTreeView = (view: TreeView<KpmItem>) => {
...
export class CodeTimeTeamProvider implements TreeDataProvider<KpmItem> {
    ...
    async getChildren(element?: KpmItem): Promise<KpmItem[]> {
        ...
        if (element) {
            ...
            kpmItems = await kpmProviderMgr.getTeamTreeParents();
        }
        return kpmItems;
    }
}
