import {HIDE_CODE_TIME_STATUS_LABEL, LOGIN_LABEL, SHOW_CODE_TIME_STATUS_LABEL, SIGN_UP_LABEL} from '../Constants';
...
export function getSignUpButton(signUpAuthName: string, iconColor?: string | null): KpmItem {
...
export function getSwitchAccountButtonItem() {
  const item: KpmItem = getActionButton('switch account button', 'Code Time', 'codetime.switchAccount');
