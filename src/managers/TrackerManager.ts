  ...
  public async trackCodeTimeEvent(projectChangeInfo: ProjectChangeInfo) {
    ...
    for await (const file of fileKeys) {
      ...
      const codetime_entity = {
        ...
        ai_characters_added: docChangeInfo.aiCharactersAdded,
        ai_characters_reverted: docChangeInfo.aiCharactersReverted,
        ai_lines_added: docChangeInfo.aiLinesAdded,
        ai_lines_reverted: docChangeInfo.aiLinesReverted,
